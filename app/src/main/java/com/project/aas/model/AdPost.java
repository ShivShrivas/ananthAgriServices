...
public class AdPost implements Serializable {
    ...
    public AdPost(String id, String title, String datePosted, String location, String postedBy, String price, String sellerPhone, List<String> imageUrls, String description, String category, String subCategory, String pinCode, String priceType, String priceUnit, String sellerWhatsapp, String adType) {
        this.id = id;
        this.title = title;
